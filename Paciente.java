...
public class Paciente extends Usuario {
	...
	private ExpedienteMedico expedienteMedico;
        ...
        public void addExpedienteMedico(ExpedienteMedico expedienteMedico){
        	//Metodo temporal para probar debugging
	    ...
	    public String impInforme(){
	       ...
	       "\n " + this.expedienteMedico.impInforme(); //Retorna atributo expedienteMedico de objeto en Paciente
	    };  
